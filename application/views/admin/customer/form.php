            ...
            <div class="modal-body">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="is_member" class="form-control demo-chosen-select" tabindex="2" id="is_member">
                ...
                <div class="form-group" id="registerPaket">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Paket Laundry</b></label>
                    <div class="col-sm-8">
                        <select name="select_paket" class="form-control" tabindex="2" id="select_paket">
                            <option value="" selected disabled>-- Pilih --</option>
