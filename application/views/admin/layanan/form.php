    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Deskripsi</b></label>
                    <div class="col-sm-8">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Deskripsi</b></label>
                    <div class="col-sm-8">
                        <input type="text" name="description" placeholder="Deskripsi" value="<?=$l->description?>" class="form-control">
                    </div>
                </div>
            </div>
            <!--Modal footer-->
