...
<script type="text/javascript">
        ...
        if(customer_id!=""){
            $.ajax({
                ...
                success: function(response){
                    ...
                    $("#paket_id").select2();
                    var selectedPaket = $("#pakets option:selected").val();
                    if (selectedPaket) {
                        pilihHargaLaundry(selectedPaket);
                    } else {
                        $("#hrg_paket").hide();
                        $("#hrg_layanan").hide();
                        $("#jml_bayar").val('');
    ...
    function registerPilihPaket(member_id) {
        console.log(member_id);
        if(member_id != "") {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Admin/Customer/register_get_paket",
                ...
                success: function(response){ 
                    ...
                    $("#registerPaket").show();
                    $("#select_paket").html(response.data_paket).show();
