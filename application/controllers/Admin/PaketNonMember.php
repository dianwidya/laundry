...
class PaketNonMember extends MY_Controller
{
    ...
    public function delete($id)
    {
        ...
        $result = $this->laundry_paket->delete($id);
        if($result == true){
            $this->session->set_flashdata('success', 'Data Paket Member Berhasil Dihapus');
        }elseif($result == false){
            $this->session->set_flashdata('failed', 'Data Paket Member Gagal Dihapus');
        }
